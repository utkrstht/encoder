...
In the [videos](/prototype/videos), you'll notice that the webm file is astronomically large, 79MB for about 1 second, that's because of extremely high quality video, that's needed to survive re-encoding and compression, down to 23MB (check downloaded.mp4), the compression doesn't cause any major corruption.
